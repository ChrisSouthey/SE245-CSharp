...
namespace Week3_Sample1
{
    class Program
    {
        ...
        { 
            ...
            // 
            //***************************************************************************************************
            Console.WriteLine("\n\nPress Any Key to Continue");     //Display a prompt for the user to know what is happening
            Console.ReadKey();                                      //Computer is waiting for a key to be pressed
            //The end!
        }
            ...
            */
            ...
            do
            {
                ...
                do
                {
                    ...
                    {
                        dblNum = Double.Parse(strNum);  //now that we know its valid, perform the conversion
                    }
